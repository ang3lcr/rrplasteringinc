    ...
    <div>
        <div id="service1" className='flex justify-center items-center flex-wrap'>
                ...
                <div className='flex flex-col justify-center items-center w-1/2'>
                    ...
                    <p className='text-xl'>EISENWALL® prevents cracking through its high-quality cement blend and advanced additives. 
        ...
        <div id="service2" className='flex justify-center items-center flex-wrap'>
                <div className='flex flex-col justify-center items-center w-1/2'>
                    ...
                    <p className='text-xl'>Ensure the durability of your construction with our professional paper wire installation service. 
        ...
        <div id="service3" className='flex justify-center items-center flex-wrap'>
                ...
                <div className='flex flex-col justify-center items-center w-1/2'>
                    ...
                    <p className='text-xl'>Discover the difference with our professional drywall services. From installations to repairs, 
