    ...
    return (
        <div className='relative w-full h-auto'>
            ...
            <div className='flex flex-col justify-center items-center mt-24 mb-24 bg-zinc-100'>
                ...
                <p className='text-xl mt-5 w-4/6 p-2'>
            ...
            <div className='flex flex-col justify-center items-center mt-24 mb-24 bg-zinc-100'>
                <p className='text-center m-10'>We specialize on big and small jobs <br /> plaster and drywall work</p>
            ...
            <div className='flex flex-col justify-center items-center bg-zinc-100'>
                <p className='text-3xl'>Important to Know</p>
                <ul className='list-disc text-xl mt-10 mb-10'>
                ...
                <p className='mb-10'>A clean job site once we've finished</p>
            </div>
            ...
            <div className='bg-zinc-100 flex justify-center items-center'>
                <div className='w-3/5 flex justify-center flex-col items-center'>
                    ...
                    <p className='text-2xl'>EISENWALL® Premium Exterior Plastering Cement</p>
                    <p className='text-xl mt-10'>Rapid Set® EISENWALL® is a high-performance cement blend, ideal for plastering and stucco applications. It provides high strength, superior durability, minimal shrinkage, and reduced cracking. Suitable for use over masonry, concrete, fiberboard, gypsum, wood, or cement-based sheathing. Environmentally friendly, emitting less CO2 than Portland cement.</p>
                    <div className='flex justify-start items-start border-2 border-solid border-red-900 w-full flex-col'>
                        <p>Advantages:</p>
                        ...
                        <p className='text-center w-full mt-5'>
                            For more details, visit <a href="https://www.ctscement.com/datasheet/EISENWALL_Datasheet_DS_027_EN?c=PRODUCTS&t=Professionals">CTS Cement.</a> 
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className='w-full flex justify-center mt-40 flex-col items-center text-center'>
                    <p className='text-3xl w-3/5'>BOND GENERAL LIABILITY AND WORKERS COMPENSATION</p>
                    <p className='text-xl w-4/5 text-start'>Get in touch with us today and let's bring your project to life! Whether you're planning a new construction, renovation, or need expert finishing services, our team is here to help. We look forward to hearing from you and being a part of your next successful project.</p>
                    <ul className='flex flex-col justify-center items-start mt-10 text-xl text-center'>
